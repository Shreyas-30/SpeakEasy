...
export type SubscriptionProvider =
  ...
  | "app_store"
  | "play_store";
export type SoftPromptTrigger =
  | "articlesRead"
  | "speakingSessions"
  | "wordsLearned";
export type HardPaywallReason =
  | "article-limit"
  | "saved-word-limit"
  | "speaking-limit";
...
export const SUBSCRIPTION_LIMITS = {
  free: {
    ...
    softPromptAfterArticlesRead: 10,
    softPromptAfterSpeakingSessions: 5,
...
> = {
  "article-limit": {
    ...
    subtext:
      "You’re making great progress. Upgrade to keep going without limits.",
